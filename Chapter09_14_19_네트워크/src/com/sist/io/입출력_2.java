package com.sist.io;
/*
 * 	I(Input)/O(Output) => 데이트를 읽기 쓰기 기능을 제공하는 라이브러리
 * 	웹 => JSON / XML
 * 		 ----------- 외부 라이브러리 
 * 		 다운로드 / 업로드 / 웹파일
 ...
 *          ***8. length() : 파일 크기
 *          ***9. lsFile() / isDirectory()
 *          ***10. exists() : 존재여부
 *          ***11. mkdir() : 폴더 생성
 *          ***12. craeatNewFile() : 파일 생성
 *          ***13. delete() : 파일 삭제
...
public class 입출력_2 {
	...
	public static void main(String[] args) {
		...
		try
		{
			...
			System.out.println("9.절대 경로:"+file.getAbsolutePath());
		}catch(Exception ex) {}
	}
