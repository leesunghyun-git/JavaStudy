 ...
 *   			
 *   			new A().aaa() = 
 *   			new A().bbb() => 다른객체 2개 생성
 * 		class ClassName
 * 		{
 * 			------------
 * 			  1. 변수
 * 				 => 인스턴스 instance : 객체마다 가지고 있는 변수
 * 					 = new를 사용시에 메모리가 따라 생성 (95%)
 *				 => 정적변수 static : 한개의 메모리만 사용 
 *					 = 생성된 모든 객체가 공유 (5%)
...
// public 초록색 동그라미 / private 빨간색 네모 / protected 노란색 마름모 / default 파란색 삼각형
class Borad
{
	public void list() {
...
class ReplayBorad extends DataBorad
{
