 ...
 *				   -------- char / byte 	
 *				char + char = int => int 보다 큰 데이터형으로 받을 수 있다
 *									--- long / float / double
 *				byte + byte = int
 *				byte + char = int
 *			
 ...
 *			효율적인 연산 => 왼쪽에 있는 조건이 false 면 오른쪽에 있는 조건은 수행하지 않음
 *			=> 사용 : 범위,기간 포함 여부 확인
 *						 ----- 예약이 가능
 *					 ---- 페이징 / 점수
 *					 ---- 오라클 : Between ~ AND
...
public class 정리_3 {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
			...
			char c1='A';
			char c2='B';
			int c3=c1+c2; //c1+c2 ==> int형  
			
			byte b1=10;
			byte b2=20;
			int b3=b1+b2; //b1+b2 ==> int형
	}
