...
public class 정리_7 {
	...
	public static void main(String[] args) throws Exception {
		...
		{
			String temp_title=title.get(i).text();
			String temp_singer=singer.get(i).text();
			if(temp_title.toUpperCase().contains(fd.toUpperCase()) || temp_singer.toUpperCase().contains(fd.toUpperCase()))
			{
				System.out.println((i+1)+"."+temp_title+"\n\t\t"+temp_singer+"\n");
				Thread.sleep(100);
			}
		}
		}
